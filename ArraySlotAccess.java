public class ArraySlotAccess
{
	public static void main(String[] args) {
		...
		//	We almost always use a for loop to 
		//	access each slot of an array.
		...
		//	Put a number into each slot of the array,
		//	one at a time.
		arr[0] = 6;
		arr[1] = 7;
		arr[2] = 8;
		//	The display the values in those slots,
		//	one at a time.
		System.out.println("Values: " + arr[0] + " " +
			arr[1] + " " + arr[2]);
		///////////////////////////////////
		//	Put a random number 1-100 into each slot
		...
		//	I hope so. If not, read through this
		//	code again more slowly.
		System.out.print("Values: ");
		for (int q=0; q < arr.length ; q++) {
